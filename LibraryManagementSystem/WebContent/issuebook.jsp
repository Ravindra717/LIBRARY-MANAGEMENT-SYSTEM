            ...
            <div class="col-md-6 offset-md-3">
                <form action="./controller/issuebooks" method="post">
                    <div class="form-group">
                        <label for="sid"  style="color:white;">Student ID</label>
                        <input type="text" class="form-control" name="sid" placeholder="Enter the student id" required>
                    </div>
                    <div class="form-group">
                        <label for="bid" style="color:white;">Book ID</label>
