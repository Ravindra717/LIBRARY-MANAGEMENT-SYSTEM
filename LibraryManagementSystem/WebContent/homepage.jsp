        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="./managebooks.jsp" class="btn btn-block btn-pink">Go to Manage Books</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="./managestudents.jsp" class="btn btn-block btn-pink">Go to Manage Students</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="./issuebook.jsp" class="btn btn-block btn-pink">Go to Issue Books</a>
                    </div>
                </div>
            </div>
        </div>
