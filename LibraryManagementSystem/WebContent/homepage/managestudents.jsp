...
<body>
	<div class="container">
		...
		<div class="options">
			...
			<a href="../searchstudent.jsp" class="btn">Search</a> <a
				href="../lib-addstudent.jsp" class="btn">Add</a> <a href="../updatestudent.jsp"
				class="btn">Update</a> <a href="../deletestudent.jsp" class="btn">Delete</a>
